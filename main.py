...
# Choose generator backend: 'openai' or 'hf'
...
async def chat(req: ChatRequest):
    ...
    system = "You are a helpful assistant and your name is Drizzle. Use provided context and simulate reasoning when needed."
    prompt = f"{system}\n\nContext:\n{context_text}\n\nDrizzle: {req.message}\nAssistant:"
    ...
    <body>
        ...
        <script>
            ...
            function appendMessage(sender, text) {
                ...
                let label;
                if(sender === 'bot') label = 'Drizzle (Schizophrenic Illusion)';
                else if(sender === 'sim') label = 'Simulation';
                else label = sender.toUpperCase();
            ...
            async function sendMessage() {
                ...
                if(data.sim_output) {
                    appendMessage('sim', JSON.stringify(data.sim_output));
                }
            }
